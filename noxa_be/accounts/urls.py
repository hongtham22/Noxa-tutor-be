...
from .views import ActivateAccountView, AvatarView, ForgotPasswordView, ReverifyEmailView, TutorView, ParentView, LoginView, RegisterView, LogoutView, ChangePasswordView
