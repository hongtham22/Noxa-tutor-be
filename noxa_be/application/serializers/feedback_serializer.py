...
class FeedbackSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        try:
            ...
            raise serializers.ValidationError(f"Error in create: {str(e)}")
    ...
    def get_parent_name(self, obj):
        try:
            ...
            raise serializers.ValidationError(f"Error in get_parent_name: {str(e)}")
    ...
    def get_parent_avt(self, obj):
        try:
            ...
            raise serializers.ValidationError(f"Error in get_parent_avt: {str(e)}")
